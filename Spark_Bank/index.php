...
<html lang="en">
  ...
  ?>
            ...
            <div class="row intro py-1">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5" style="background-image: url('https://i.pinimg.com/originals/75/f5/a4/75f5a4bf815ae6c8f9d79da0e3655594.gif');">
                  <h3>Welcome to</h3>
                  <h1>THE SPARKS FOUNDATION BANK <i class="fas fa-university"></i></i></h1>
                </div>
              </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="createusers.php"><button>Create a User</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made with &hearts; by <b>TEJASHWINI K</b> <br> The Sparks Foundation</p>
      </footer>
